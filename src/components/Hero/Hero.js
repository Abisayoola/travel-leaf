  ...
  return (
    <div className='hero container'>
      <div className='hero-text'>
        ...
        <p>Discover, Book, and Experience the Best Cannabis-Friendly Accommodations, Vehicles, Yachts, and Unique Adventures.</p>
        <div className='bookingSearch'>
            ...
            Location
              <div classname='bookingSearchResult'>
                 ...
                 <input type='text' placeholder='Florida, USA' className='searchInput'/>
             </div>
             </div>
             <div className='bookingSearchItem'>
                Arrival Date
            ...
            <button className='searchbtn'><img src={search_normal} alt=''/>Search</button>
        </div>
      </div>
    </div>
  )
